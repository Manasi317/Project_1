...
require 'config.php';
	...
	$db_found = new mysqli($servername, $username, $password,$dbname);
...
<?PHP print $wholeHTML; ?>
<P><INPUT TYPE = "Submit" Name = "Submit1"  VALUE = "Select Question"></P>
</FORM>
<FORM NAME ="form2" METHOD ="POST" ACTION ="Activities.php">
<P><INPUT TYPE = "Submit" Name = "Submit2"  VALUE = "Logout"></P>
</FORM>
</body>
</html>
<?php
