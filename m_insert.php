...
<body>
    ...
    <div class="wrapper">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="SurveySubmenu">
                        <li>
                            <a href="setQuestion.php">Insert Enteries</a>
                        </li>
                        <li>
        ...
        <div id="content">
            ...
            <form class="needs-validation" style="align:center;" action="server.php" method="post" novalidate>
              <div class="form-row">
              ...
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" name="u_name" id="validationCustom02" placeholder="NAME" value="" required>
             ...
             <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" name="u_type" id="validationCustom03" placeholder="TYPE" value="" required>
              ...
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="password" class="form-control" name="u_password" id="validationCustom01" placeholder="PASSWORD" value="" required>
