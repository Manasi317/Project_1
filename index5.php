...
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                 ...
                 <li>
                    <a href="#quizSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Quiz</a>
        ...
        <div id="content">
            ...
            <p style="text-align=left;"><span style="font-family:Cooper Black; text-align:center;">
              WELCOME ADMIN!</span><br>
            <img src="img_avatar2.png" alt="Avatar" class="avatar" width="30%" height="30%">
              <img src="avatar2.png" alt="Avatar" class="avatar" width="30%" height="30%">

            <br></p>
            <span style="text-align:center;font-family:Cooper Black;font-style: oblique;font-size: 3em;">&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspYou can now provide the updates..</span>
